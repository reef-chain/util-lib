...
describe('toInjectedAccountsWithMeta', () => {
    it('should add meta information to each injected account', () => {
        ...
        const expected = [
            { address: '0x123', meta: { name: 'Account 1', source: 'REEF_EXTENSION_IDENT' } }, 
            { address: '0x456', meta: { name: 'Account 2', source: 'REEF_EXTENSION_IDENT' } }, 
            { address: '0x789', meta: { name: 'Account 3', source: 'REEF_EXTENSION_IDENT' } },
        ];
