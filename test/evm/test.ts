...
(async function test() {
  ...
  const signingKey = new MnemonicSigner(
    "burger provide angry return spell silver ceiling produce antenna decrease evolve private"
  );
  ...
  console.log(
    "isValid=",
    await isValidSignature(signMessage, signedResult.signature, signingAddress)
  );
})();
