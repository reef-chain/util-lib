...
describe('getTokenEthAddressListPrices', () => {
    it('should return valid prices for a list of existing token addresses', async () => {
        const prices = await getTokenEthAddressListPrices(['0x1f9840a85d5af5bf1d1762f925bdaddc4201f984', '0x7fc66500c84a76ad7e9c93437bfc5ac33e2ddae9']);
        expect(prices['0x1f9840a85d5af5bf1d1762f925bdaddc4201f984']).toBeGreaterThan(0);
        expect(prices['0x7fc66500c84a76ad7e9c93437bfc5ac33e2ddae9']).toBeGreaterThan(0);
    });

    it('should not return a price for a non-existent token address', async () => {
        const prices = await getTokenEthAddressListPrices(['0x1f9840a85d5af5bf1d1762f925bdaddc4201f984', '0xnonexistentaddress']);
        expect(prices['0x1f9840a85d5af5bf1d1762f925bdaddc4201f984']).toBeGreaterThan(0);
