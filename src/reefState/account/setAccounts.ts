...
export const setAccounts = (
  accounts:
    ...
    | InjectedAccountWithMetaReef[]
    | null
) => accountsJsonSubj.next(accounts);

export const selectedAddressSubj: Subject<string | undefined> = new Subject<
  string | undefined
>();
export const setSelectedAddress = (address: string | undefined) =>
  selectedAddressSubj.next(address);
